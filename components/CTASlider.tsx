  ...
  return (
    <section className=" flex flex-col justify-center items-center gap-28">
      <div className="flex flex-col-reverse lg:flex-row gap-8 lg:gap-16 px-10 sm:px-0">
        <div className="w-full sm:w-[22em] flex flex-col gap-5 lg:gap-28 justify-between lg:py-16">
          <div>
        ...
        <Swiper
          ...
          slidesPerView={1}
          autoplay={{ delay: 2000 }}
          className="w-[20em] shadow-xl sm:w-[25em] h-[35em] rounded-lg overflow-hidden"
        >
